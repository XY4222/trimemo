...
from trimemo.sources.transforms import (
...
def test_resolve_adapter_priority_order():
    ...
    # Default is filesystem (preserves existing ``trimemo mine <path>`` behavior).
...
def test_palace_context_drawer_id_is_sha256_prefix_not_sha1():
    ...
    from trimemo.sources.context import _build_drawer_id
