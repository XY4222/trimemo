...
class TestLoadKnownNames:
    def test_returns_names_from_registry(self):
        ...
        with patch("trimemo.entity_registry.EntityRegistry") as MockER:
    ...
    def test_returns_empty_on_exception(self):
        with patch(
            "trimemo.entity_registry.EntityRegistry.load",
...
class TestSpellerEdgeCases:
    ...
    def test_system_word_not_corrected(self):
        ...
        with patch("trimemo.spellcheck._get_speller", return_value=fake_speller):
            with patch("trimemo.spellcheck._get_system_words", return_value={"coherently"}):
                with patch("trimemo.spellcheck._load_known_names", return_value=set()):
