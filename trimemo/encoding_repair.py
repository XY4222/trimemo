"""Safely repair high-confidence UTF-8 mojibake in TriMemo drawers."""
...
_BACKUP_FORMAT = "trimemo-encoding-repair"
_BACKUP_VERSION = 1
...
def _collection_name(
    ...
    """Resolve a collection name through TriMemo backend wrappers."""
