...
Usage:
    from trimemo.spellcheck import spellcheck_user_text
...
# CamelCase: ChromaDB, TriMemo, LongMemEval
...
if __name__ == "__main__":
    ...
    for msg in test_cases:
        result = spellcheck_user_text(msg, known_names={"riley", "sam", "trimemo"})
