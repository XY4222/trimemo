...
Usage:
    python -m trimemo.diary_ingest --dir ~/daily_summaries --palace ~/.mempalace/palace
    python -m trimemo.diary_ingest --dir ~/daily_summaries --palace ~/.mempalace/palace --force
"""
