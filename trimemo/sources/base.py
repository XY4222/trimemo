"""Source adapter contract for TriMemo (RFC 002).

Mirrors what ``trimemo/backends/base.py`` does for the write side: it defines
...
This module is spec scaffolding. The first-party miners (``trimemo/miner.py``
and ``trimemo/convo_miner.py``) are migrated onto it in a follow-up PR;
