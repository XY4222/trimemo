...
def cmd_mine(args):
    ...
    # Heuristic-only by design — full LLM detection lives on `trimemo init`.
    ...
    try:
        ...
        print(
            ...
            "  index is rebuilt. `trimemo repair --yes` rebuilds the FTS5 virtual\n"
    ...
    *,
    ...
    try:
        ...
        raise UnknownSourceAdapterError(
            ...
            "check the adapter name with `trimemo mine --help`"
        ) from exc
    ...
    if "supports_incremental" in adapter.capabilities:
        raise UnsupportedSourceAdapterProtocolError(
            ...
            "trimemo mine does not support yet"
        )
