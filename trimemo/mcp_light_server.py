#!/usr/bin/env python3
"""
TriMemo Lightweight MCP Server
================================
Consolidates 45 TriMemo tools into a high-performance 3-tool interface
...
LIGHT_TOOLS = {
    ...
    "palace_coordinate": {
        "description": (
            ...
            "Accepts a concise coordination DSL string (e.g. 'TASK CREATE project:trimemo from:agent1 "
    ...
    if method == "initialize":
        ...
        return {
            ...
            "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "trimemo-light", "version": __version__},
            },
        }
    elif method == "ping":
...
def main():
    parser = argparse.ArgumentParser(description="TriMemo Lightweight MCP Server")
    ...
    for stream in (sys.stdin, sys.stdout):
        if hasattr(stream, "reconfigure"):
            try:
                ...
                pass
    logger.info("TriMemo Lightweight MCP Server starting (3 consolidated tools)...")
