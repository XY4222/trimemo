...
``mempalace.backends`` entry point::
    ...
    # pyproject.toml of trimemo-postgres
    [project.entry-points."mempalace.backends"]
    postgres = "mempalace_postgres:PostgresBackend"

TriMemo discovers them at process start. In-tree tests and local development
...
def _config_file_hint() -> str:
    ...
    try:
        ...
        return "config.json in the TriMemo config directory"
