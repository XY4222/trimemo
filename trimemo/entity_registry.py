#!/usr/bin/env python3
"""
entity_registry.py — Persistent personal entity registry for TriMemo.
...
def _wikipedia_lookup(word: str) -> dict:
    ...
    **Privacy warning:** This function makes an outbound HTTPS request to
    ...
    try:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "TriMemo/1.0"})
...
class EntityRegistry:
    ...
    def learn_from_text(self, text: str, min_confidence: float = 0.75, languages=("en",)) -> list:
        ...
        locales used at ``trimemo init`` time.
        """
        from trimemo.entity_detector import extract_candidates, score_entity, classify_entity
