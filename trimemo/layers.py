#!/usr/bin/env python3
"""
layers.py — 4-Layer Memory Stack for trimemo
===================================================
...
def _open_for_read(palace_path: str):
    ...
    schema, and every one of these call sites runs while some other TriMemo
    ...
    trimemo mine <dir>", which invited a re-mine of a perfectly healthy palace.
...
def _read_open_failure(exc: Exception) -> str:
    ...
    return "No palace found. Run: trimemo mine <dir>"
