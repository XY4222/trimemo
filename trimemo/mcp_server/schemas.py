...
TOOLS = {
    ...
    "mempalace_get_aaak_spec": {
        "description": "Get the AAAK dialect specification — the compressed memory format TriMemo uses. Call this if you need to read or write AAAK-compressed memories.",
        "input_schema": {"type": "object", "properties": {}},
    ...
    "mempalace_mine": {
        "description": (
            "Mine a directory into the palace — the MCP equivalent of `trimemo mine`. "
            ...
            "the trimemo[extract] extra). Runs synchronously and returns the miner's "
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "agent": {
                    "type": "string",
                    "description": "Recorded on every drawer (default: trimemo).",
                },
                "limit": {
                    "type": "integer",
    ...
    "mempalace_event_append": {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "stream": {
                    "type": "string",
                    "description": "Logical stream, e.g. 'project/trimemo' or 'shared_agent_brain'",
                },
                "room": {
                    "type": "string",
    ...
    "mempalace_patch_submit": {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "stream": {
                    "type": "string",
                    "description": "Logical stream, e.g. 'project/trimemo'",
                },
