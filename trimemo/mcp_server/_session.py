        ...
        for attempt in range(2):
            try:
                ...
                _collection_open_error = {
                    ...
                    "hint": "Run: trimemo status or trimemo repair-status for diagnostics.",
                }
        return None
        ...
        try:
            ...
            if attempt == 0:
                ...
                _collection_open_error = {
                    ...
                    "hint": "Run: trimemo repair-status for diagnostics.",
                }
    _client_cache = None
    _collection_cache = None
    _collection_cache_backend = None
...
def _no_palace():
    return {
        ...
        "hint": "Run: trimemo init <dir> && trimemo mine <dir>",
    }
