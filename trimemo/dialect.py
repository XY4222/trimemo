...
Adapted for trimemo: works standalone on plain text and ChromaDB drawers.
...
class Dialect:
    ...
    def __init__(
        ...
        from trimemo.i18n import load_lang, t, current_lang, get_regex
    ...
    # === PLAIN TEXT COMPRESSION (new for trimemo) ===
